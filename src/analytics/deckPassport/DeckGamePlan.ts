...
const WIN_PLAN: Record<string, string> = {
  ...
  Control: "Выматывание обменами и точечный урон Miner/Drill при преимуществе в эликсире",
...
const ATTACK_TIMING: Record<string, string> = {
  "Быстрый цикл": "Сразу после выгодного обмена или когда win снова в руке — не держать эликсир",
...
function primaryThreatText(primaryWin: string | null, cardNames: string[], archetype: string): string {
  ...
  return "Нет явной win-condition — давление размыто";
}
