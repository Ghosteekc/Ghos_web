...
export const api = {
  ...
  prefetchDeckTabs: () => {
    ...
    void cachedGet<ArenaDecksData>("arena-decks-v6", "/api/decks/arena", TTL.arenaDecks).catch(() => {});
  },
  ...
  getArenaDecks: () =>
    cachedGet<ArenaDecksData>("arena-decks-v6", "/api/decks/arena", TTL.arenaDecks),
