...
export const api = {
  ...
  getProfile: () => cachedGet<Profile>("profile-v6", "/api/me", TTL.profile),
  ...
  getPlayerPreview: (tag: string) => {
    ...
    return cachedGet<SearchResult>(`player-v3:${clean}`, `/api/players/${encodeURIComponent(clean)}`, TTL.profile);
  },
