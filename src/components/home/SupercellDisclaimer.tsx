...
export function SupercellDisclaimer() {
  return (
    <footer className="pt-2 pb-4 px-1">
      <p className="text-[10px] leading-relaxed text-cr-accent text-center">
      ...
      <p className="text-[10px] leading-relaxed text-cr-accent text-center mt-2">
        Материалы неофициальны и не одобрены Supercell.{" "}
        <a
          href={FAN_CONTENT_POLICY_URL}
          target="_blank"
          rel="noopener noreferrer"
          className="text-cr-blue underline underline-offset-2"
        >
